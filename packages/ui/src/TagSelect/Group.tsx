...
const Group: React.FC<TagSelectGroupProps> = ({
    ...
    const [value, setValue] = useState<Array<TagSelectValueType>>(toArray(defaultValue || restProps.value));
    ...
    const childrenNode = options.length ? memoOptions.map<React.ReactNode>(option => (
        <Item
