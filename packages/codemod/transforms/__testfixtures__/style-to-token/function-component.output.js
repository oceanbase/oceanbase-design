...
function Demo1() {
  ...
  return (
    <div>
      <Alert style={{ color: obToken.colorTextDefault, background: obToken.colorBgSecondary, backgroundColor: obToken.colorBgHoverSecondary, border: `1px solid ${obToken.colorBorderDefault}`, fontSize: obToken.fontSize325, fontWeight: obToken.fontWeightMd, borderRadius: obToken.radiusSm }} />
      <Button style={{ color: obToken.colorTextLink, background: obToken.colorTextSuccess, backgroundColor: obToken.colorTextWarning, borderColor: obToken.colorTextError, fontSize: obToken.fontSize300, fontWeight: obToken.fontWeightLg, borderRadius: obToken.radiusMd }}></Button>
