...
- 🆕 新增 `progressProps` 属性，用于设置图标模式下 `processing` 状态的进度信息。
...
<code src="./demo/status-inner.tsx" title="状态点和状态图标和其他组件组合使用" description="字体大小和颜色应该继承父元素。" debug></code>
...
| progressProps | 用于设置图标模式下 `processing` 状态的进度信息 | [ProgressProps](https://ant.design/components/progress-cn/) | - | - |
