...
/**
 * Playground：与 `../index.figma.tsx` 中第一条 `figma.connect`（DescriptionGroup）的 props / example 一致。
 * 单一 `position`（page | drawer | popover）驱动 bordered、column、layout、size、title、items、style、styles。
 * 抽屉 / 弹层用 Button + useState 打开，便于对照 Figma 中不同容器场景；左侧预览区限制宽度并允许横向滚动，避免挤压右侧配置栏。
 */
