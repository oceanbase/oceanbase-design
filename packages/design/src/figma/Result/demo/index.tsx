...
const STYLE: CSSProperties = { padding: 24, background: '#ffffff', width: '100%' };
...
function FigmaResultExample(props: {
  ...
  const { status, title, subTitle, extra, style } = props;
  return <Result status={status} title={title} subTitle={subTitle} extra={extra} style={style} />;
}
