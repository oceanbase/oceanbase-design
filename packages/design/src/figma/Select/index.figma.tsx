...
/**
 * Code Connect — Select（单选 / 多选标签与占位等变体矩阵）。
 * Page: "↵Select"
 *
 * 遵循 gen-figma §3.1：用离散 props 映射 Figma 的 placeholder / multiple / status，
 * example 仅组装 `<Select />`，不做整段 ReactNode 透传。
 */
